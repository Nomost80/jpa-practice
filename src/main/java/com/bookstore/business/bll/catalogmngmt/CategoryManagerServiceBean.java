...
public class CategoryManagerServiceBean{
    ...
    public List<Category> getRootCategories() {
        return this.em.createNamedQuery("getRootCategories", Category.class).getResultList();
    }
    ...
    */
    public List<Category> getchildrenCategories(Long parentId) {
        TypedQuery<Category> query = this.em.createNamedQuery("getChildrenCategories", Category.class);
